    ...
    <div   className=" justify-center items-center gap-[88px] inline-flex">
        <div className="flex-col justify-start items-center gap-6 inline-flex">
            <div className="w-20 h-20 relative">
                ...
                <div className="w-10 h-10 left-[23px] top-[22px] absolute"><FaTruckFast color="white"  size="2em"  /></div>
            </div>
        ...
        <div className="w-[262px] flex-col justify-start items-center gap-6 inline-flex">
            <div className="w-20 h-20 relative">
                ...
                <div className="w-10 h-10 left-[23px] top-[22px] absolute"><TfiHeadphoneAlt  color="white" size="2em" /> </div>
            </div>
            <div className="flex-col justify-start items-center gap-2 flex">
                <div className="text-black text-xl font-semibold font-['Poppins'] leading-7">
        ...
        <div className="flex-col justify-start items-center gap-6 inline-flex">
            <div className="w-20 h-20 relative">
                ...
                <div className="w-10 h-10 left-[25px] top-[23px] absolute"> <BiMessageSquareCheck color="white" size="2em" /> </div>
            </div>
            <div className="flex-col justify-start items-center gap-2 flex">
                <div className="text-black text-xl font-semibold font-['Poppins'] leading-7">
