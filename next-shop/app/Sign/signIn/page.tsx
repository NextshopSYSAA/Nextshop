  ...
  return (
    <div className='bg-white	'>
        ...
        <div className='flex flex-row'  style={{height:'750px', width:'800px', paddingTop:'80px', gap:'129px'}}>
            ...
            <div className='flex flex-col' style={{width:'371px',height:'530px',gap:'48px',paddingTop:'100px'}}>
              ...
              <div className='flex flex-row space-x-20'>
                <button type="button"className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-xs px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
                style={{width:'120px', height:'46px'}} >Log In</button>
                   <h6 className='text-xxs text-[#ef4444] whitespace-nowrap'>Forget password?</h6>
                            </div>
